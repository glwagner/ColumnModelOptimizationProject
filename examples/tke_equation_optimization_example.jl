...
visualize_realizations(model, data, [21, 401], default_parameters, optimal_parameters, 
                       fields=(:U, :V, :T, :e))

plot_loss_function(loss, model, data, default_parameters, optimal_parameters)
visualize_loss_function(loss, model, data, 401, default_parameters, optimal_parameters)
