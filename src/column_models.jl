...
struct ColumnModelTimeseries{T}
    N  :: Int
    L  :: T
    Fb :: T
    Fu :: T
...
"""
    ColumnModelTimeseries(datapath)

Construct ColumnModelTimeseries from a standardized dataset.
"""
function ColumnModelTimeseries(datapath)
    ...
    ColumnModelTimeseries(N, L, Fb, Fu, Bz, K₀, α, g, f, t, U, V, T, S, E)
end
