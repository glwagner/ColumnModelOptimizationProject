...
#filename = "tke_batch_calibration_stability_dz2_dt1.jld2"
#filename = "tke_batch_calibration_stability_dz4_dt2.jld2"
fontsize = 8
fs = 12
...
calibration = try
    load(filename, "calibration")
catch
    load(joinpath("data", filename), "calibration")
end
