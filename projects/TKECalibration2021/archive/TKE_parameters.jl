...
# Create a FreeParameters struct in `ColumnModelOptimizationProject` (or in https://github.com/glwagner/ColumnModelOptimizationProject/blob/master/projects/tke_with_convection/setup.jl) with
